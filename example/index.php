...
Dynamic demand forecasting indicates that a mainstream approach may establish a basis for leading-edge information processing to insure the diversity of granularity in encompassing expansion of content provided within the multimedia framework under examination. of this cyberspace communication. 
</p>
...
<?
// sidebar heading
echo $navDOM->find('.menu-financial-industry a',0)->setAttr('id','section-title');
// sidebar subnav
echo $navDOM->find('.menu-financial-industry ul',0)->setAttr('id','subnav');
?>
</div>
